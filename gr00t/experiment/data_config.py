...
class AlohaSingleArmDataConfig:
    video_keys = [
        "video.middle_view",
        "video.right_view",
        "video.left_view",
...
class AlohaSingleArm4CamerasDataConfig:
    video_keys = [
        "video.middle_top_view",
        "video.wrist_view",
        "video.edge_view",
        "video.middle_low_view",
    ]
    state_keys = [
        "state.arm_joints",
        "state.gripper",
...
DATA_CONFIG_MAP = {
    ...
    "aloha_single_arm": AlohaSingleArmDataConfig(),
    "aloha_single_arm_4_cameras": AlohaSingleArm4CamerasDataConfig(),
}
